    ...
    <form id="form1" runat="server">
        <div class="d-flex justify-content-center align-items-center" style="min-height: 100vh; padding: 15px;">
            <div align="center" class="container bg-light boxshadow col-12 col-sm-8 col-md-6 col-lg-4 col-xl-3" style="border-radius: 15px; padding: 0; max-width: 400px;">
                <div>
                        <div class="text-white rounded-top d-flex align-items-center justify-content-center" style="padding: 15px; background-color: #ee6c4d;">
                    ...
                    <div class="px-4 py-4">
                        ...
                        <div class="text-center mb-2">   
                            <asp:LinkButton ID="LinkButtonRecordarContra" runat="server" CssClass="btn btn-link p-0" style="font-size: 12px; text-decoration: none;">¿Olvidó contraseña?</asp:LinkButton>
                        </div>
...
<%--   Boton de recordarme (pendiente, si llego lo agrego)    
                        <div class="form-group form-check mb-3">
                            ...
                            <label class="form-check-label" for="passLabel">Recordarme?</label>
                             ...
                             <asp:Button ID="ButtonIngresar" runat="server" Text="Ingresar" CssClass="btn btn-primary w-100" BackColor="#ee6c4d" />
                    </div>
                </div>
            </div>
        </div>
